            ...
            DJSUtil.forEach(
                ...
                function(script, index) {
                    ...
                    if(!script.dominated && DJSUtil.getAttribute.call(script, 'type') === 'text/djs') {
                        ...
                        if(slave.external && !urlCache[slave.src] && !self.executing) {
                            slave.precache(

                                function(success) {

                                    if(captives[0] == slave && self.executing) {
 ...
 */
                            ...
                            if(self.executing && captives[0] == slave) {
        ...
        execute: function(callback) {
            ...
            self.executing = true;
            self.executionCallback = callback || executionCallback;

            DJSUtil.log('Attmepting to execute next script...');
